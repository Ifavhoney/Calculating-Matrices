...
long hash2(char *s, int max)
{
    ...
    /*Special case needed for x1 && MD && L1 && LH && RA && B1-2*/
    ...
    if (strstr(s, "G3"))
    {
        ...
        long result = strtol(string, &end, 10) / 2;

        printf("||TH result:%s||\n", string);
        return labs(hash(result)) % max;
    }

    if (strstr(s, "MD") == s || strstr(s, "JT") == s)
    {
        for (c = s; *c; c++)
        {
    ...
    if (strstr(s, "CA") == s || strstr(s, "LH") == s || strstr(s, "DA") == s || strstr(s, "MT") == s || strstr(s, "ME") == s || strstr(s, "DN") == s || strstr(s, "FA") == s)
    {
        for (c = s; *c; c++)
        {
    ...
    if (strstr(s, "RS") == s || strstr(s, "RB") == s || strstr(s, "N1") == s || strstr(s, "R1") == s || strstr(s, "R2") == s || strstr(s, "R3") == s || strstr(s, "R4") == s)
    {
    ...
    if (strstr(s, "I4") == s || strstr(s, "M5") == s)
    {
        for (c = s; *c; c++)
        {
    ...
    if (strstr(s, "X1") == s || strstr(s, "X2") == s || strstr(s, "X3") == s || strstr(s, "X4") == s || strstr(s, "X5") == s)
    {
        for (c = s; *c; c++)
        {
    ...
    if (strstr(s, "M1") == s || strstr(s, "H1") == s || strstr(s, "O1") == s || strstr(s, "C1") == s ||
        ...
        strstr(s, "J1") == s || strstr(s, "L1") == s || strstr(s, "C9") == s || strstr(s, "L5") == s || strstr(s, "L4") == s || strstr(s, "L3") == s || strstr(s, "L2") == s || strstr(s, "C2") == s || strstr(s, "C3") == s || strstr(s, "C4") == s || strstr(s, "C5") == s || strstr(s, "J2") == s || strstr(s, "J3") == s || strstr(s, "J4") == s ||
        strstr(s, "ing") == NULL)
    {
    ...
    */
...

    {
        ...
        */
        ...
        strcat(string, preString);
        long result = strtol(string, &end, 10) % max;
        printf("||GPN:%d||\n", result);
        return labs(hash(result)) % max;
    }
